...
export async function loadAllIntegrations(
  ...
  for (const [name, options] of Object.entries(
    ...
    else if (typeof mod === 'object' && typeof mod.default === 'function') { integration = mod.default(options) }
    else if (typeof mod === 'object' && typeof mod.default === 'object') { integration = mod.default }
    else {
      throw new TypeError(
